...
def filtro_media(img):
    ...
    for x in range(1, largura - 1):
        for y in range(1, altura - 1):
            ...
            pixel12 = pixels[x - 1, y - 1][0]
            pixel13 = pixels[x - 1, y - 1][0]
            pixel21 = pixels[x, y][0]
            pixel22 = pixels[x, y][0]
            pixel23 = pixels[x, y][0]
            pixel31 = pixels[x + 1, y + 1][0]
            pixel32 = pixels[x + 1, y + 1][0]
            ...
            pixel12 = pixels[x - 1, y - 1][1]
            pixel13 = pixels[x - 1, y - 1][1]
            pixel21 = pixels[x, y][1]
            pixel22 = pixels[x, y][1]
            pixel23 = pixels[x, y][1]
            pixel31 = pixels[x + 1, y + 1][1]
            pixel32 = pixels[x + 1, y + 1][1]
            ...
            pixel12 = pixels[x - 1, y - 1][2]
            pixel13 = pixels[x - 1, y - 1][2]
            pixel21 = pixels[x, y][2]
            pixel22 = pixels[x, y][2]
            pixel23 = pixels[x, y][2]
            pixel31 = pixels[x + 1, y + 1][2]
            pixel32 = pixels[x + 1, y + 1][2]
